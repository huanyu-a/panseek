...
const SEARCH_URL = "https://www.qnmp4.com/index.php/ajax/suggest?mid=1&limit=20&wd=";

export class QiweiPlugin extends BaseAsyncPlugin {
  constructor() {
    super("qiwei", 3);
  }
  ...
  override async search(keyword: string): Promise<SearchResult[]> {
    ...
    for (const r of results) {
      r.unique_id = r.unique_id.replace('plugin-', 'qiwei-');
    }

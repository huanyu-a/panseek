...
const SEARCH_URL = "https://www.gaoqing888.com/search?kw=";

export class Gaoqing888Plugin extends BaseAsyncPlugin {
  constructor() {
    super("gaoqing888", 3);
  }
  ...
  override async search(keyword: string): Promise<SearchResult[]> {
    ...
    for (const r of results) {
      r.unique_id = r.unique_id.replace('plugin-', 'gaoqing888-');
    }

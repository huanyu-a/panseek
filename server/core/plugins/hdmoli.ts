...
const SEARCH_URL = "https://www.hdmoli.pro/search.php?searchkey=";

export class HdmoliPlugin extends BaseAsyncPlugin {
  constructor() {
    super("hdmoli", 3);
  }
  ...
  override async search(keyword: string): Promise<SearchResult[]> {
    ...
    for (const r of results) {
      r.unique_id = r.unique_id.replace('plugin-', 'hdmoli-');
    }
